...
- [#157](https://github.com/MikeNotThePope/substrateui/pull/157) [`4d22bbf`](https://github.com/MikeNotThePope/substrateui/commit/4d22bbf5c393eb250d3a8c1fed96a58aaa8deb4c) Thanks [@lavahire-pr-opener](https://github.com/apps/lavahire-pr-opener)! - `Item` takes `render`, so a list of actions can be a list of buttons.

  `Item` drew a `div` and nothing else, which meant a row that _does_ something
...
- [#155](https://github.com/MikeNotThePope/substrateui/pull/155) [`15d0509`](https://github.com/MikeNotThePope/substrateui/commit/15d0509be157883b905aeb6c1fdb82d3de714eee) Thanks [@lavahire-pr-opener](https://github.com/apps/lavahire-pr-opener)! - ChoiceCard: `RadioGroupCard` and `CheckboxCard`, where the whole row is the target
...
- [#153](https://github.com/MikeNotThePope/substrateui/pull/153) [`594a74b`](https://github.com/MikeNotThePope/substrateui/commit/594a74bc0537a03138016bb2ade8e5dcae584c6e) Thanks [@lavahire-pr-opener](https://github.com/apps/lavahire-pr-opener)! - `FloatingAction`, the round corner launcher on its own, and `positionMethod` on `DropdownMenuContent`
...
- [#150](https://github.com/MikeNotThePope/substrateui/pull/150) [`c786990`](https://github.com/MikeNotThePope/substrateui/commit/c786990a8e1ac6e28dc91806163f755e46a8f6d3) Thanks [@lavahire-pr-opener](https://github.com/apps/lavahire-pr-opener)! - `NavShell`: a `NavShellBrandStrip` header for shells with no navigation
...
- [#148](https://github.com/MikeNotThePope/substrateui/pull/148) [`f2c5961`](https://github.com/MikeNotThePope/substrateui/commit/f2c5961efa7467424ccdd7619cf3b5cb6388f52c) Thanks [@lavahire-pr-opener](https://github.com/apps/lavahire-pr-opener)! - `Sheet`: a `dockAt` breakpoint, above which the sheet stops being an overlay
...
- [#146](https://github.com/MikeNotThePope/substrateui/pull/146) [`3dca1ab`](https://github.com/MikeNotThePope/substrateui/commit/3dca1abb6a12a06c331af255ba804ef8e3d8407e) Thanks [@lavahire-pr-opener](https://github.com/apps/lavahire-pr-opener)! - `Tabs` gains `unstackAt`, for panes that are tabs on a phone and side by side on a laptop.
...
- [#143](https://github.com/MikeNotThePope/substrateui/pull/143) [`010ff39`](https://github.com/MikeNotThePope/substrateui/commit/010ff39effeb16a73a8781a54958be7971cb6804) Thanks [@lavahire-pr-opener](https://github.com/apps/lavahire-pr-opener)! - Four patterns a consumer had hand-rolled now ship from the system ([#123](https://github.com/MikeNotThePope/substrateui/issues/123), items 1, 5, 8 and 12).
...
- [#134](https://github.com/MikeNotThePope/substrateui/pull/134) [`6416dd6`](https://github.com/MikeNotThePope/substrateui/commit/6416dd6922a2942ea5f95775cb6090730abcb14d) Thanks [@lavahire-pr-opener](https://github.com/apps/lavahire-pr-opener)! - Five patterns consumers were hand-building, from the drift audit in [#123](https://github.com/MikeNotThePope/substrateui/issues/123).
...
- [#132](https://github.com/MikeNotThePope/substrateui/pull/132) [`aa6e698`](https://github.com/MikeNotThePope/substrateui/commit/aa6e698999682edbc0f69f9f9d8b76f7a52066da) Thanks [@lavahire-pr-opener](https://github.com/apps/lavahire-pr-opener)! - Move `Calendar` and `DatePicker` out of the root barrel to their own entry, `@mikenotthepope/substrateui/date`.

  The root re-exported the picker, so importing any atom from the root loaded react-day-picker and all of date-fns: 1549 modules on a root import against 188 on the subpaths, and a consumer's DOM test file that took 5.3s to start instead of 1.1s ([#122](https://github.com/MikeNotThePope/substrateui/issues/122)). Every other atom stays at the root. Consumers of the picker change one import path; nobody else changes anything.
...
- [#109](https://github.com/MikeNotThePope/substrateui/pull/109) [`edc9bae`](https://github.com/MikeNotThePope/substrateui/commit/edc9bae7c5c3b39b424167fe5b09b2aa6d3e1aa2) Thanks [@MikeNotThePope](https://github.com/MikeNotThePope)! - Fix the README's import paths, which named a package that isn't this one.
...
- [#104](https://github.com/MikeNotThePope/substrateui/pull/104) [`00d3536`](https://github.com/MikeNotThePope/substrateui/commit/00d353619391b24d385768570721ed2d40e090a5) Thanks [@MikeNotThePope](https://github.com/MikeNotThePope)! - Publish the class recipes and `cn()` without a client boundary.
...
- [#101](https://github.com/MikeNotThePope/substrateui/pull/101) [`96d770f`](https://github.com/MikeNotThePope/substrateui/commit/96d770f6f1eac42521d6a255d90d563546991676) Thanks [@MikeNotThePope](https://github.com/MikeNotThePope)! - Focus rings no longer fire on a mouse click. Five components declared theirs on `focus:` rather than `focus-visible:` — the Dialog and Sheet close buttons, the Select trigger, Cascader, and Badge — all carrying the same class string character for character, while eleven other components already used the right one. They now match.
