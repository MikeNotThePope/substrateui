...
export const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "ThemeToggle", href: "/docs/components/theme-toggle" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "FileDropField", href: "/docs/components/file-drop-field" },
    ],
  },
  {
    title: "Form Patterns",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "MessageThread", href: "/docs/components/message-thread" },
